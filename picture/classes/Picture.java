...
public class Picture extends SimplePicture 
{
                 ...
                 int startRow, int startCol, int sRow, int eRow, int sCol, int eCol)
  {
    ...
    for (int fromRow = sRow, toRow = startRow; 
         ...
         fromRow++, toRow++)
    {
      for (int fromCol = sRow, toCol = startCol; 
           fromCol < eRow &&
           toCol < toPixels[0].length;  
           fromCol++, toCol++)
      {
  ...
  public void createCollage()
  {
    ...
    this.copy(flower1,0,0,0,80,0,80);
    this.copy(flower2,100,0,0,80,0,80);
    this.copy(flower1,200,0,0,80,0,80);
    Picture flowerNoBlue = new Picture(flower2);
    flowerNoBlue.zeroBlue();
    this.copy(flowerNoBlue,300,0,0,80,0,80);
    this.copy(flower1,400,0,0,80,0,80);
    this.copy(flower2,500,0,0,80,0,80);
    this.mirrorVertical();
  ...
  public void myCollage()
  {
    ...
    Picture gf = new Picture("flower2.jpg");
	gf.grayscale();
	this.copy(gf,0,0,0,70,29,20);
    f1.zeroBlue();
    this.copy(f1,200,0,0,80,0,80);
    //Picture flowerNoBlue = new Picture(flower2);
    //flowerNoBlue.zeroBlue();
    //this.copy(flowerNoBlue,300,0,0,80,0,80);
	f2.negate();
    this.copy(f2,400,0,0,80,0,80);
    //this.copy(flower2,500,0,0,80,0,80);
    this.mirrorVertical();
    this.write("collage.jpg");
  }
