public class Magpie2
{
	...
	public String getResponse(String statement)
	{
		 ...
		 * if you mention "Robinette" in your statement */
				...
				|| findKeyword(statement, "fish", 0) != -1
				|| findKeyword(statement, "turtle", 0) != -1)
		{
		...
		/* New String variable phrase = a more searchable version of statement.
		   ...
		   startPos
			...
			As long as psn >= 0...
				...
				while(psn >= 0)// || psn <= phrase.length() - goal.length())
				{
					if(psn > 0)
					...
					if(psn < phrase.length() - goal.length())
					...
					if(before.compareTo("a") == -65
					&& after.compareTo("z") == -90)
						return psn;
					else
						psn += 1;
				}
